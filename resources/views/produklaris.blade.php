...
<html>
<head>
    <title>ProdukLaris</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">
    <link rel="style sheet" href="#";>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,300;0,400;0,700;1,400&family=Roboto&display=swap" rel="stylesheet">
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary p-4 shadow-sm sticky-top">
        <div class="container-fluid container">
          ...
          <a class="navbar-brand ms-3" href="#">Produk Terlaris</a>
      ...
      <section id="item" class="mt-4 ">
        <div class="container">
          <div class="row">
              <a href="produk6"><div class="col-3">
                  <div class="card">
              ...
              <div class="col-3">
                  <a href="produk1">
                      <div class="card">
                          <img src="{{asset('image/Produk 1.jpg')}} " class="card-img-top w-500" alt="...">
                          <div class="card-body">
      ...
      <section id="item" class="mt-4">
        <div class="container">
          <div class="row">
              <a href="produk2"><div class="col-3">
                  <div class="card">
              ...
              <div class="col-3">
                  <a href="#">
                      <div class="card">
                          <img src="{{asset('image/Produk 4.jpg')}}" class="card-img-top" alt="...">
                          <div class="card-body">
