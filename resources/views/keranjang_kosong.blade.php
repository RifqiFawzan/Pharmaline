...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary p-4 shadow-sm sticky-top">
    <div class="container-fluid container">
      ...
      <section class="jumbotron text-center ms-3 pt-5 pb-5">
        <img src="{{asset('image/keranjang2.png')}}" class="p" width="200">
        <h1>Wah,Keranjang Belanjamu kosong</h1>
        <p>Isi keranjangmu dengan barang-barang terbaik di Pharmaline.</p>
        <p>Yuk,cek sekarang!</p>
        <div class="cek_sekarang">
          <div class="btn btn-orange-moon btn-rounded ">Belanja sekarang</div>
        </div>
      </section>
